...
use super::{
    mut_channel::{MutChannel, MutReceiver, MutReceiverBuilder, MutSender},
};
...
impl<E: Copy + Eq + Hash, K: ProtocolKindType> GlobalDiffHandler<E, K> {
    ...
    pub fn register_component(
        ...
        if self.mut_receiver_builders.contains_key(&(*entity, *component_kind)) {
    ...
    pub fn receiver(&self, addr: &SocketAddr, entity: &E, component_kind: &K) -> Option<MutReceiver> {
