...
A cross-platform (currently WebAssembly & Linux, although Windows & MacOS have been reported working as well) networking engine that intends to make multiplayer game development in Rust dead simple and lightning fast.
