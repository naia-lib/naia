...
status: G3a COMPLETE — audit (§2h) incorporated + all blockers RESOLVED (editor in-scope, H3 single-world, §2e internal-queueing no-panic, G9pre spike scheduled) — G7 ready for sign-off
