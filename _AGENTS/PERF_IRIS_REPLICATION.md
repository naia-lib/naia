...
**Status:** IN PROGRESS — C.7.A ✅ (a9808eed) + C.7.B compact-key ✅ (1859d651) + record_update_dense ✅ (665bb9ec) + C.7.B full-flat-Vec ✅ (pending commit); C.7.C+D wire-cache still pending
